...
saveRDS(tfmlengthandorder,file = "../data/liverlengthandorderall.rds")
tfmlengthandorder <- readRDS("../data/liverlengthandorderall.rds")
...
png("../output/gsealiverresuball.png")
...
png("../output/dotplotliverresuball.png")
...
write_lines(tfmhilistfile$stat,"tfhilistall.txt")
write_lines(tfmlowlistfile$stat,"tflowlistall.txt")
...
saveRDS(all.df,"../data/Alltissuetyperesuball.rds")
