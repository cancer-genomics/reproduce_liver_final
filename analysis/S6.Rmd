...
se<-read_csv(here("data","two_test_plan","delfi-results_screen.csv"))
se2<-read_csv(here("data","two_test_plan","delfi-tf-results_risk.csv"))
...
```{r roc_categories,fig.width = 10, fig.height = 10, message=FALSE, warning=FALSE,dev=c("png", "pdf")}
